...
def main():
    ...
    # Reproduce command
    reproduce_parser = subparsers.add_parser('reproduce', help='Reproduce all figures from paper')
    ...
    reproduce_parser.add_argument(
        '--smoke',
        action='store_true',
        help='Run smoke test with 5%% subsample'
    )

    # Legacy smoke command for backward compatibility
    smoke_parser = subparsers.add_parser('smoke', help='Run fast smoke test with subsampled data')
